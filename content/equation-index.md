...
+++ {"oxa":"oxa:VNMrkxzChhdveZyf6lmb/1oG2RfNTKhSPAmCGyNA2.13"}
...
+++ {"oxa":"oxa:VNMrkxzChhdveZyf6lmb/nMhKCJMtSvLz5oZvnlMe.6"}

$$\mathbf{g}_j(\mathbf{x}) = e^{p_j\mathbf{x}} cos (2 \pi q_j \mathbf{x}) \Delta x$$

+++ {"oxa":"oxa:VNMrkxzChhdveZyf6lmb/V9tgF8Wdjl6sEEWWPM2C.5"}
